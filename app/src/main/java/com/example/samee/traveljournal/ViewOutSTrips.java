...
public class ViewOutSTrips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_out_strips);
        setTitle("Out of State Trips");
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    startActivity(new Intent(ViewOutSTrips.this,ProfileActivity.class));


                }
                else if(id==R.id.locations)
                {
                    startActivity(new Intent(ViewOutSTrips.this,ViewLocations.class));
                }
                else if(id==R.id.cityTrips)
                {
                    startActivity(new Intent(ViewOutSTrips.this,ViewCityTrips.class));


                }
                else if(id==R.id.outCityTrips)
                {
                    startActivity(new Intent(ViewOutSTrips.this,ViewOutCTrips.class));
        ...
        stateLists=(ListView)findViewById(R.id.viewStateTrips);
        stateLists.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                final DataSnapshot snapshot=snapshots.get(position);
                PopupMenu popupMenu=new PopupMenu(ViewOutSTrips.this,stateLists);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if(item.getItemId()==R.id.delete)
                        {
                            ...
                            FirebaseDatabase.getInstance().getReference("posts").child(firebaseUser.getUid())
                                    .child("Out of State Trips").child(snapshot.getKey()).removeValue();
        ...
        actionButton=(FloatingActionButton)findViewById(R.id.addState);
        final ArrayAdapter arrayAdapter=new ArrayAdapter(this,android.R.layout.simple_list_item_1,tripNames);
        stateLists.setAdapter(arrayAdapter);
        actionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ViewOutSTrips.this,CreatePostActivity.class));
            }
        });
        stateLists.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(ViewOutSTrips.this,TripDetails.class);
        ...
        FirebaseDatabase.getInstance().getReference("posts").child(firebaseUser.getUid())
                .child("Out of State Trips").addChildEventListener(new ChildEventListener() {
            @Override
